...
class KaziOfficeDetailsScreen extends StatefulWidget {
  final String des;
  const KaziOfficeDetailsScreen({super.key, required this.des});

  @override
  State<KaziOfficeDetailsScreen> createState() => _KaziOfficeDetailsScreenState();
}

class _KaziOfficeDetailsScreenState extends State<KaziOfficeDetailsScreen> {
