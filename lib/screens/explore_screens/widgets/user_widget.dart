...
// import 'package:islamic_marriage/screens/explore_screens/controllers/filtered_bio_data_controller.dart';
...
//     return GetBuilder<AllBioDataController>(builder: (allUserController) {
...
//         }
//         if (allUserController.allBioData == null ||
//             allUserController.allBioData!.data!.isEmpty) {
...
//                       final user = allUserController.allBioData!.data![index];
//                       return CustomCard(
//                         height: 220.h,
//                         border:
...
//                     itemCount: allUserController.allBioData!.data!.length,
//                   ),
//                 ),
//                 Gap(8.h),
//               ],
