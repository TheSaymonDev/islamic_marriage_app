class Wishlist {
  List<Biodata>? favouriteLists;
  Wishlist(this.favouriteLists);

  Wishlist.fromJson(Map<String, dynamic> json) {
    if (json['favouriteLists'] != null) {
      favouriteLists = <Biodata>[];
      json['favouriteLists'].forEach((v) {
        favouriteLists!.add(new Biodata.fromJson(v));
      });
    }
  }
}
...
class Biodata {
  ...
  Biodata.fromJson(Map<String, dynamic> json) {
    ...
    currentAddress = json['currentAddress'] != null
        ? new PermanentAddress.fromJson(json['currentAddress'])
        : null;
